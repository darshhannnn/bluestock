...
const BasicsTechnicalAnalysis = () => (
  <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10">
    ...
    <div className="w-full max-w-4xl bg-white rounded-xl shadow p-6 mb-8">
      ...
      <div className="text-xs text-gray-400 mb-2">Home / Technical Analysis / Basics of Technical analysis</div>
      <h1 className="text-2xl font-bold mb-4">Basics of Technical analysis</h1>
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Type of Charts Card */}
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow flex flex-col gap-4">
            <h2 className="text-lg font-bold text-blue-700 mb-2">Type of Charts</h2>
            <div className="flex flex-col gap-2">
              <p className="text-gray-700 text-sm">
                Earlier, price movement used to be shown in a series of points and lines (line charts). Chart creation and the different types of charts available are important concepts for any technical analyst.\n\nCharts can be shown in several forms and represent a graphical price action idea. The main types are line charts, bar charts, and candlestick charts. Line charts are the simplest, showing closing prices over time. Bar charts add more detail, displaying open, high, low, and close prices for each period. Candlestick charts, popular in modern analysis, use colored bodies to represent price movement and are favored for their visual clarity.\n\nUnderstanding chart types is crucial for technical analysis, as each type offers unique insights into price behavior. In this module, you’ll learn how to read and interpret these charts effectively with real examples.
              </p>
              <img src="https://cdn.pixabay.com/photo/2017/01/31/13/14/arrow-2023449_1280.png" alt="Chart Types Example" className="h-28 object-contain mt-2" />
            </div>
          </div>
        </div>
      </div>
...
export default BasicsTechnicalAnalysis;
